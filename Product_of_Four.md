...
****[****http://github/ghjoss/Product_of_Four/ProductOfFour.odt****](http://github/ghjoss/Product_of_Four/ProductOfFour.odt)****
that has 198,000+ f(n,k) combinations where there is a V\_{
****n**<sub>**0**</sub>** } among the results. This was generated by the
Rust language program, main.rs, in the src folder. The program loads a
set of postgres database tables with the results. The database key
fields contain not the f(n0) values but the square root of
f(****n**<sub>**0**</sub>**). For entries where f(n,k), with k ≠ n,
generates the same value as f(****n**<sub>**0**</sub>**,****n**<sub>**0
**</sub>**), the σ2(****n**<sub>**0 **</sub><sup>**2**</sup>**) is
denoted in the row. ****
